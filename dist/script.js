...
var forms = function forms() {
  ...
  var postDtata = function postDtata(url, data) {
    var res;
    return regeneratorRuntime.async(function postDtata$(_context) {
      while (1) {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      postDtata('assets/server.php', formData).then(function (res) {
        console.log(res);
        statusMessage.textContent = message.success;
      }).catch(function () {
        return statusMessage.textContent = message.failur;
      }).finally(function () {
        clearInputs();
        setTimeout(function () {
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    close.addEventListener('click', function () {
      ...
      document.body.style.overflow = ''; // document.body.classList.remove('modal-open'); // bootstrap
    });
